...
SUMMARY_FIELDS = [
    ...
    "loop_accepted_vertical_neutral",
    ...
    "loop_consensus_candidate_count",
    "loop_consensus_commit_count",
    "loop_consensus_defer_count",
    "loop_consensus_reject_count",
    "loop_consensus_estimator_candidate_count",
    "loop_consensus_estimator_valid_count",
    "loop_consensus_estimator_trial_candidate_count",
    "loop_consensus_estimator_trial_success_count",
    "loop_bad_z_after_consensus_commit_count",
    ...
    "loop_bad_z_after_consensus_estimator_z_mad_mean",
    "loop_bad_z_after_consensus_estimator_delta_mean",
    "loop_corrected_z_consensus_estimator_z_mad_mean",
    "loop_corrected_z_consensus_estimator_delta_mean",
    "loop_bad_z_after_consensus_estimator_trial_z_mean",
    "loop_corrected_z_consensus_estimator_trial_z_mean",
    "loop_precision",
...
def summarize_run(args, run_name, run_dir, matrix_output):
    ...
    if diagnosis_path:
        ...
        mapping = {
            ...
            "accepted_vertical_neutral": "loop_accepted_vertical_neutral",
            ...
            "consensus_candidate_count": "loop_consensus_candidate_count",
            "consensus_commit_count": "loop_consensus_commit_count",
            "consensus_defer_count": "loop_consensus_defer_count",
            "consensus_reject_count": "loop_consensus_reject_count",
            "consensus_estimator_candidate_count": "loop_consensus_estimator_candidate_count",
            "consensus_estimator_valid_count": "loop_consensus_estimator_valid_count",
            "consensus_estimator_trial_candidate_count": "loop_consensus_estimator_trial_candidate_count",
            "consensus_estimator_trial_success_count": "loop_consensus_estimator_trial_success_count",
            "accepted_true_loop_bad_z_after_consensus_commit": "loop_bad_z_after_consensus_commit_count",
            ...
            "accepted_true_loop_bad_z_after_consensus_estimator_z_mad_mean": "loop_bad_z_after_consensus_estimator_z_mad_mean",
            "accepted_true_loop_bad_z_after_consensus_estimator_delta_mean": "loop_bad_z_after_consensus_estimator_delta_mean",
            "accepted_true_loop_corrected_z_consensus_estimator_z_mad_mean": "loop_corrected_z_consensus_estimator_z_mad_mean",
            "accepted_true_loop_corrected_z_consensus_estimator_delta_mean": "loop_corrected_z_consensus_estimator_delta_mean",
            "accepted_true_loop_bad_z_after_consensus_estimator_trial_z_mean": "loop_bad_z_after_consensus_estimator_trial_z_mean",
            "accepted_true_loop_corrected_z_consensus_estimator_trial_z_mean": "loop_corrected_z_consensus_estimator_trial_z_mean",
